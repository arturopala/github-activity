        ...
        [ describe ".decodeRepo should"
            [ test "decode valid repo json" <|
                \() ->
                    let
                        underTest =
                            decodeString GitHub.Decode.decodeRepoLink
                                """{
                                 "id": 1296269,
                    ...
                    underTest
                        |> Expect.all
                            [ expectOk errorToString
                                [ having .id (Expect.equal 1296269)
                                , having .name (Expect.equal "Hello-World")
                                , having .url (having Url.toString (Expect.equal "https://api.github.com/repos/octocat/Hello-World"))
                                ]
                            ]
