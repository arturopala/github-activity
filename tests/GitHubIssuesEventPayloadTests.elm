module GitHubIssuesEventPayloadTests exposing (all)
...
all : Test
all =
    describe "decodeIssuesEventPayload should"
        [ test "decode valid IssuesEvent json" <|
            \() ->
                let
                    underTest =
                        decodeString GitHub.Decode.decodeIssuesEventPayload
                            """{
                                 "action": "edited",
                                 "issue": {
                ...
                underTest
                    |> Expect.all
                        [ expectOk errorToString
                            [ having .action (Expect.equal "edited")
                            , having .issue
                                (Expect.all
